...
export function activityOf(task: Task | null): Activity {
  ...
  switch (task.id) {
    ...
    case "sticks": case "bark": case "stone": case "berries": case "eggs": case "innerBark": case "roots": case "tapSap": case "seaweed": case "deadwood": case "hunt": case "findDen": case "fish": case "fill": case "hang": case "read": case "setTrap": case "emptyTrap": case "makeCamp": case "findShelter": return "light";
