...
import type { GameState, Inventory, Player, Site, ToolId } from "./types";
...
export function campWaterCapacity(inv: Inventory, st?: Site | null): number {
  let l = 0;
...
export function campWaterRoom(inv: Inventory, st?: Site | null): number {
...
export function pourVessels(p: Player, inv: Inventory, st?: Site | null): number {
