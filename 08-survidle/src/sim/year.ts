...
export interface YearReport {
  ...
  /** kcal of large game (LARGE_GAME plus bear) among those kills, from the actual yield of each (fat and carbohydrate design, ruling R3), read against APRIL.rows.largeGame. */
  killsKcal: number;
