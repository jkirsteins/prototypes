...
type KnownSlot =
  ...
  | "axe" | "knap"
  | "startle_contact" | "startle_hoof_light_forest" | "startle_hoof_heavy_forest"
...
export const SLOTS: Record<Cue | KnownSlot, SlotDef> = {
  ...
  // Departures: contact, surface movement and receding impacts, never a call or chime.
  startle_contact: shot(0.7, "startle_contact_01.ogg", "startle_contact_02.ogg"),
  startle_hoof_light_forest: shot(0.7, "startle_hoof_light_forest_01.ogg", "startle_hoof_light_forest_02.ogg"),
  startle_hoof_heavy_forest: shot(0.8, "startle_hoof_heavy_forest_01.ogg", "startle_hoof_heavy_forest_02.ogg"),
  startle_hoof_light_open: shot(0.65, "startle_hoof_light_open_01.ogg", "startle_hoof_light_open_02.ogg"),
  startle_hoof_heavy_open: shot(0.75, "startle_hoof_heavy_open_01.ogg", "startle_hoof_heavy_open_02.ogg"),
  startle_hoof_bog: shot(0.75, "startle_hoof_bog_01.ogg", "startle_hoof_bog_02.ogg"),
  startle_hoof_snow: shot(0.7, "startle_hoof_snow_01.ogg", "startle_hoof_snow_02.ogg"),
  // Reserved for species-specific predator departures; ungulate events never select it.
  startle_brush_predator: shot(0.6, "startle_brush_predator_01.ogg", "startle_brush_predator_02.ogg"),
  // Moments.
