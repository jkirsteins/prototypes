...
export const MOVE_HELP: Record<MoveState["kind"], MoveHelpEntry> = {
  ...
  ledgeHang:  { label: "hang",        what: "Caught a lip and holding on; a jump beside an edge catches it on the way down.", player: "{climbUp} climbs on, {climbDown} or steering away lets go, {jump} leaps away." },
  ledgeGrab:  { label: "ledge",       what: "Pulling up over the lip.", player: "Committed: it ends standing on the platform." },
